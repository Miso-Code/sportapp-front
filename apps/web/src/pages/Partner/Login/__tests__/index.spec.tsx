...
describe('LoginPage', () => {
	...
	it('should render the card title', () => {
		expect(screen.getByText('login.partner.title')).toBeInTheDocument()
	})
	...
	it('should call setAlert when the form is submitted', async () => {
		...
		;(usePartnerAuthStore as unknown as jest.Mock).mockReturnValue({
	...
	it('should called navigate to register page', async () => {
		...
		await waitFor(() =>
			expect(navigate).toHaveBeenCalledWith('/partner/register')
		)
	})
})
