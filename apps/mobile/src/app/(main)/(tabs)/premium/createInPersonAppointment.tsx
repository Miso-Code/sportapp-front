...
const CreateInPersonAppointment: React.FC = () => {
	...
	const handleCreateInPersonAppointment = async () => {
		...
		const response = await addSportsmanAppointment({
			...
			appointment_location: selectedLocation
		})
				...
				<View style={styles.wrapper}>
					<View style={styles.form}>
						<Text variant='titleMedium'>
							{t('preference.form.inPersonAppointment.title')}
						</Text>
						<DatePickerInput
						...
						<SquaredButton
							...
							onPress={handleCreateInPersonAppointment}
							disabled={
								!date ||
								!time ||
								!selectedTrainer ||
